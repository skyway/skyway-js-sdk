...
class Socket extends EventEmitter {
   ...
   * @param {string} newCredential - The new credential generated by user.
   */
  updateCredential(newCredential) {
    ...
    if (parseQuery.credential) {
      parseQuery.credential = newCredential;
    } else {
      // To reviewer:
      //   When the first new Peer w/o credential,
      //   Should we just do nothing in this method,
      //   or just emit/warn messages like this?
      util.warn('Credential isn\'t given before. Are you sure to do this?');
    }
