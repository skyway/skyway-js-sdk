...
```html
<script type="text/javascript" src="https://cdn.webrtc.ecl.ntt.com/skyway-4.4.0.js"></script>
```
...
To use the compressed version, add `.min` to the end of the file name, like `skyway-4.4.0.min.js`.
